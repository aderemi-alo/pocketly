...
final class $$UsersTableReferences
    extends BaseReferences<_$PocketlyDatabase, $UsersTable, User> {
  $$UsersTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static MultiTypedResultKey<$CategoriesTable, List<Category>>
      _categoriesRefsTable(_$PocketlyDatabase db) =>
          MultiTypedResultKey.fromTable(db.categories,
              aliasName:
                  $_aliasNameGenerator(db.users.id, db.categories.userId));
...
class $$UsersTableFilterComposer
    extends Composer<_$PocketlyDatabase, $UsersTable> {
...
final class $$CategoriesTableReferences
    extends BaseReferences<_$PocketlyDatabase, $CategoriesTable, Category> {
...
class $$CategoriesTableFilterComposer
    extends Composer<_$PocketlyDatabase, $CategoriesTable> {
  $$CategoriesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$CategoriesTableTableManager extends RootTableManager<
    ...
    Category,
    PrefetchHooks Function({bool userId, bool expensesRefs})> {
  $$CategoriesTableTableManager(_$PocketlyDatabase db, $CategoriesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({userId = false, expensesRefs = false}) {
            return PrefetchHooks(
              db: db,
...
final class $$ExpensesTableReferences
    extends BaseReferences<_$PocketlyDatabase, $ExpensesTable, Expense> {
  ...
  static $CategoriesTable _categoryIdTable(_$PocketlyDatabase db) =>
...
class $$ExpensesTableFilterComposer
    extends Composer<_$PocketlyDatabase, $ExpensesTable> {
  $$ExpensesTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ExpensesTableTableManager extends RootTableManager<
  ...
  $$ExpensesTableTableManager(_$PocketlyDatabase db, $ExpensesTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $PocketlyDatabaseManager {
  ...
  $PocketlyDatabaseManager(this._db);
